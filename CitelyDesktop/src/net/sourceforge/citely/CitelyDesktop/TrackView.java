...
public class TrackView extends ViewPart {
	public static final String ID = "CitelyDesktop.TrackView";

	private TrackPanel _trackPanel = null;
	...
	public void createPartControl(Composite parent) {
		...
		_trackPanel = new TrackPanel(parent, SWT.NONE);
		GridData trackPanelData = new GridData(GridData.FILL, GridData.BEGINNING, false, false);
		_trackPanel.setLayoutData(trackPanelData);
	}
